        ...
        <main className="min-h-screen pb-20 pt-8 bg-charcoal">
            <div className="max-w-4xl mx-auto px-4 md:px-8">
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-4xl md:text-5xl font-black tracking-tighter mb-1 flex items-center gap-3">
                            <MessageCircle className="w-8 h-8 text-periwinkle" />
                            Mensagens
                        </h1>
                        <p className="text-slate-light font-medium">As tuas conversas.</p>
                    </div>
                </div>
                ...
                <div className="clay-card overflow-hidden">
                    {conversations.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-20 text-slate-light">
                            ...
                            <p className="text-sm mt-1">Quando alguém te enviar uma mensagem, aparece aqui.</p>
                        </div>
                    ) : (
                        <div className="divide-y divide-slate-700/50">
                            {conversations.map((conv: any) => (
                                <Link
                                    ...
                                    className="flex items-center gap-4 p-5 hover:bg-hover-bg transition-colors group"
                                >
                                    <div className="w-12 h-12 rounded-full bg-periwinkle/20 flex items-center justify-center overflow-hidden flex-shrink-0 border-2 border-slate-700">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-2">
                                            ...
                                            {conv.last_message_at && (
                                                <span className="text-[10px] font-bold text-slate-lighter uppercase whitespace-nowrap">
