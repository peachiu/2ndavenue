        ...
        <main className="min-h-screen bg-charcoal pb-32 pt-32 md:pt-28 select-none">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                <div className="flex items-center gap-4 mb-12">
                    ...
                    <div>
                        <h1 className="text-4xl font-black tracking-tighter lowercase">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-32 space-y-4">
                        <Heart className="w-12 h-12 text-slate-lighter mx-auto" />
                        <p className="text-xl font-bold text-slate-light lowercase italic">ainda não tens favoritos</p>
