...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-50">
            <div className="bg-white/80 backdrop-blur-md border border-white/20 rounded-full px-6 py-3 flex items-center justify-between shadow-clay-card hover:shadow-clay-hover transition-all duration-500 group">
                ...
                <Link href="/" className="flex items-center gap-3">
                    ...
                    <span className="text-xl font-black tracking-tight text-slate-800 lowercase hidden sm:block">
                        secondavenue
                    </span>
                </Link>
                ...
                <div className="hidden md:flex items-center gap-8">
                    <Link href="/feed" className="text-sm font-bold text-slate-500 hover:text-periwinkle transition-colors lowercase">
                        {t("nav.feed")}
                    </Link>
                    <Link href="#" className="text-sm font-bold text-slate-500 hover:text-periwinkle transition-colors lowercase">
                        {t("nav.collections")}
                    </Link>
                    <Link href="#" className="text-sm font-bold text-slate-500 hover:text-periwinkle transition-colors lowercase">
                        {t("nav.about")}
